...
TICKERS = {
    ...
    "GOOG": {"name": "Alphabet Inc.", "sector": "Technology", "icon": "", "image": "assets/logos/goog.png", "logo_size": 56, "header_image": "assets/logos/header/goog.png", "url": "https://abc.xyz"},
...
# ── Model Configuration ──────────────────────────────────────────────
MODEL_PATH = "ml/model/"          # Directory where the trained model lives
...
# One-hot ticker columns expected by the all-tickers model.
# This must match exactly what was used during training.
# After re-running ml/train_model.py, update this list with the printed TICKER_DUMMIES output.
TICKER_DUMMIES = ["ticker_AMZN", "ticker_GOOG", "ticker_MSFT", "ticker_NVDA"]
