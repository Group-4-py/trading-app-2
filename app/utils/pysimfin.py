...
class PySimFin:
    ...
    def __init__(self, api_key: str):
        ...
        self.heads = {"Authorization": f"api-key {self.api_key}"}
    ...
    def _request(self, endpoint: str, params: dict = None) -> dict:
        ...
        try:
            response = self._session.get(url, headers=self.heads, params=params, timeout=30)
    ...
    def get_share_prices(
        ...
        # Normalize v3 column names to standard OHLCV format
        col_map = {
